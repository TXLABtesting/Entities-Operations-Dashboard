...
import { HISTORY, QUOTE } from "@/data/history";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          paddingBlock: stacked ? "10px 56px" : "clamp(40px,6vw,80px)",
        }}
      >
        <div
          className="text-right"
          style={{
            maxWidth: stacked ? "100%" : "min(440px,38%)",
        ...
        >
          ...
          <div
            className="mt-[22px] font-semibold text-[#8A97AD]"
...
function Principles() {
  ...
  return (
    <section
      style={{
        background:
          "linear-gradient(180deg,#0B2A66 0%,#0D2450 62%,#0F1F3D 100%)",
      }}
    >
      <div className="mx-auto max-w-[1120px] px-8 pt-16 pb-[72px]">
        <div data-reveal className="mb-11 text-center">
          <h2
            ...
            style={{ fontSize: "clamp(30px,3.4vw,44px)", fontWeight: 500 }}
          >
            المبادئ العامة
          </h2>
        ...
        >
          {PRINCIPLES.map(principle => (
            <div
              key={principle.n}
              data-reveal
              className="flex items-start gap-[22px] border-b border-white/[.09] px-1 py-[26px]"
            >
              <div
              ...
              <div>
                <div className="text-[17px] font-extrabold leading-[1.7] text-white">
                  {principle.title}
                </div>
                <div className="mt-[6px] text-[13px] font-semibold leading-[2] text-[#9DB6DF]">
                  {principle.desc}
                </div>
              </div>
            </div>
