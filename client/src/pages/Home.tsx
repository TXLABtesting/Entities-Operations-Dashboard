...
import { PhaseTimeline } from "@/components/site/PhaseTimeline";
import { TargetColumn } from "@/components/site/TargetColumn";
import { useScrollReveal } from "@/hooks/useScrollReveal";
import { useMediaQuery } from "@/hooks/useMediaQuery";
import { MEDIA } from "@/lib/brand";
import { NEWS } from "@/data/news";
import { PHASES, TARGETS } from "@/data/phases";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(360deg, #2E4359, #20488150, #FFFFFFA0)",
        }}
      />
...
function Intro() {
  return (
    <section dir="rtl" className="relative overflow-hidden bg-white">
      ...
      >
        <div
          className="mx-auto flex max-w-[900px] flex-col items-center"
          style={{ gap: "clamp(24px,3.5vw,40px)" }}
        >
          <div data-reveal className="text-center">
            <div className="mb-[18px] flex items-center justify-center gap-[14px]">
              <div
                className="h-[3.5px] w-16"
                style={{ background: "linear-gradient(90deg,#01BDF9,#2563EB)" }}
              />
            </div>
            <div
              style={{
          ...
          >
            بتوجيهات من صاحب السمو الشيخ محمد بن زايد آل نهيان، رئيس الدولة
            "حفظه الله"، أعلن صاحب السمو الشيخ محمد بن راشد آل مكتوم، نائب رئيس
            الدولة رئيس مجلس الوزراء حاكم دبي "رعاه الله"، في أبريل 2026 عن
            إطلاق مشروع وطني استراتيجي، بإشراف سمو الشيخ منصور بن زايد آل نهيان،
            نائب رئيس الدولة نائب رئيس مجلس الوزراء رئيس ديوان الرئاسة، يهدف إلى
            تحويل 50% من العمليات والمهام والإجراءات والخدمات الحكومية إلى نماذج
            وأنظمة مدعومة بالذكاء الاصطناعي المساعد خلال عامين، بما يسهم في خفض
            التكاليف التشغيلية، ورفع الكفاءة الحكومية، وتعزيز جودة المخرجات
            والخدمات، وتسريع الإنجاز، ودعم اتخاذ القرار، وذلك لبناء أفضل حكومة
            في العالم ولتعزيز جاهزية الدولة لمتغيرات المستقبل.
          </div>
        </div>
        ...
        <div
          data-reveal
          className="relative"
          style={{ height: "clamp(280px,34vw,480px)" }}
        >
          <img
            src={MEDIA.introCabinet}
            alt=""
          ...
          <div
            ...
            style={{ background: "linear-gradient(180deg,#01BDF9,#2563EB)" }}
          />
        </div>
      </div>
    </section>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          paddingBlock: stacked ? "12px 56px" : "clamp(64px,8vw,110px)",
        }}
      >
        <div style={{ maxWidth: stacked ? "100%" : 480 }}>
          <div data-reveal className="mb-6 flex items-center gap-[14px]">
            <div
              className="h-[3.5px] w-16"
              style={{ background: "linear-gradient(90deg,#01BDF9,#7FD4F7)" }}
            />
          </div>
          <p
            data-reveal
          ...
          >
            دولة الإمارات تقود الحكومات عالمياً نحو توظيف وتطبيق{" "}
            <span
              style={{
...
function Targets() {
  ...
  return (
    <section
      ...
      style={{ padding: "clamp(20px,3vw,40px) 0 0" }}
    >
      <div ref={ref} data-reveal className="mx-auto max-w-[1220px] px-5">
        <div
          ...
          style={{
            padding:
              "clamp(8px,1.4vw,20px) clamp(24px,4vw,60px) clamp(16px,2.5vw,36px)",
          }}
        >
          ...
          >
            {/* soft halo behind the columns */}
            <div
              className="pointer-events-none absolute left-1/2 top-[30%] z-0 h-[420px] -translate-x-1/2 -translate-y-1/2 rounded-[50%]"
              style={{
                width: "min(760px,80vw)",
                background:
                  "radial-gradient(50% 50% at 50% 50%,rgba(1,189,249,.12),rgba(37,99,235,.05) 55%,transparent 75%)",
                filter: "blur(18px)",
              }}
            />
            {/* ground fade so the columns sit in the page rather than on it */}
            <div
              ...
              style={{
                ...
                maskImage:
                  "radial-gradient(95% 120% at 50% 100%,#000 60%,rgba(0,0,0,.65) 84%,transparent 100%)",
                WebkitMaskImage:
                  "radial-gradient(95% 120% at 50% 100%,#000 60%,rgba(0,0,0,.65) 84%,transparent 100%)",
              }}
            />
...
function News() {
  ...
  // The track slides by one card + gap; measure it so the step follows the
  // fluid card width at every breakpoint.
  useEffect(() => {
    const measure = () => {
  ...
  return (
    <section id="news" dir="rtl" className="relative bg-[#F4F7FB] pt-14 pb-2">
      <div className="mx-auto max-w-[1220px]">
        <div
          data-reveal
          className="mb-12 flex flex-wrap items-end justify-between gap-x-10 gap-y-6 px-5"
        >
      ...
      <div
        data-reveal
        style={{ padding: "0 max(20px, calc(50vw - 590px)) 0 20px" }}
      >
        <div
          className="overflow-hidden pt-[14px] pb-[90px] -mb-[60px]"
          style={{
            WebkitMaskImage:
              "linear-gradient(to left,#000 0%,#000 84%,rgba(0,0,0,.35) 95%,rgba(0,0,0,0) 100%)",
            maskImage:
              "linear-gradient(to left,#000 0%,#000 84%,rgba(0,0,0,.35) 95%,rgba(0,0,0,0) 100%)",
          }}
        >
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    minHeight: "clamp(210px,44vw,340px)",
                  }}
                >
                  {/* blurred bleed so portrait crops fill the frame cleanly */}
                  <img
                    src={item.image}
                    alt=""
                    aria-hidden
                ...
                <div
                  ...
                  style={{
                    ...
                    padding:
                      "clamp(22px,4.4vw,32px) clamp(20px,4vw,30px) clamp(20px,3.6vw,28px)",
                  }}
                >
                  <h3
                    className="m-0 text-[#0F1F3D]"
                    style={{
                      fontSize: "clamp(17px,3.9vw,22px)",
                      fontWeight: 400,
                      lineHeight: 1.65,
                      textWrap: "pretty",
                    }}
                  ...
                  <p
                    className="mt-[14px] text-sm font-semibold leading-[2] text-[#5E6E8C]"
                  ...
                  <div className="flex items-end justify-between gap-5">
                    <div>
                      <div className="text-[11px] font-bold text-[#8A97AD]">
                        التاريخ:
                      </div>
                      <div className="mt-[3px] text-[13.5px] font-extrabold text-[#0F1F3D]">
                        {item.date}
                      </div>
                    </div>
                    <a
...
function Streams() {
  ...
  return (
    <section
      dir="rtl"
      className="relative -mt-10 bg-[#F4F7FB] pt-[100px] pb-[110px]"
    >
      <div className="flex flex-col justify-center overflow-hidden">
        <div className="relative z-[2] mx-auto w-full max-w-[1220px] flex-none">
          <div
            data-reveal
            className="mb-10 flex flex-wrap items-end justify-between gap-6 px-5"
          >
            <div>
              <h2
                className="m-0 text-[#0F1F3D]"
              ...
              <div
                className="mt-[10px] font-semibold leading-[2.1] text-[#5E6E8C]"
                style={{ fontSize: "clamp(14.5px,1.5vw,17px)" }}
              >
                خمسة مسارات رئيسية تقود التحول نحو حكومة مدعومة بالذكاء
                الاصطناعي المساعد.
              </div>
            </div>
              ...
              >
                <div className="relative z-[2] flex h-full flex-col justify-center gap-[14px]">
                  ...
                  <div
                    ...
                    style={{
                      background: "linear-gradient(90deg,#01BDF9,#2563EB)",
                    }}
                  />
                  <p
